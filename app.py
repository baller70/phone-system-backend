...
def answer_call():
    ...
    try:
        ...
        # This ensures the full menu with all options plays immediately on answer
        ncco = create_ivr_menu_ncco()
        
        print(f"✅ Returning FULL IVR MENU NCCO for call {call_uuid}")
        return jsonify(ncco)
